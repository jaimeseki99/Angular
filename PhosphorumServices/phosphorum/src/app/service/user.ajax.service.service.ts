...
export class UserAjaxService {
    ...
    createOne(userFormValue: IUser): Observable<IUser> {
        return this.oHttpClient.post<IUser>(this.sUrl, userFormValue);
    }

    updateOne(userFormValue: IUser): Observable<IUser> {
        return this.oHttpClient.put<IUser>(this.sUrl, userFormValue);
    }
