...
export class ThreadAjaxService {
    ...
    createOne(userFormValue: IThread): Observable<IThread> {
        return this.oHttpClient.post<IThread>(this.sUrl, userFormValue);
    }

    updateOne(userFormValue: IThread): Observable<IThread> {
        return this.oHttpClient.put<IThread>(this.sUrl, userFormValue);
    }
